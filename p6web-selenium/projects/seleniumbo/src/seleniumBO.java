...
public class seleniumBO {
	...
	*/
	...
	String BO_CreateFinancialPeriod(String sFinName, String sStartDate,String sFinishDate) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException{
		Object[] newValues = new Object[4];
		newValues[0]="MyPrimaveraBOFunction";
		newValues[1]="create-FinancialPeriod";
		newValues[2] = "FinancialPeriodName|FinancialPeriodStartDate|FinancialPeriodEndDate";
		newValues[3] = sFinName+"|"+ sStartDate+"|" + sFinishDate;
	...
	public static void main(String aa[]) throws Exception {
		...
		/**
		 * seleniumBO selBO = new seleniumBO("admin", "admin", "PMDB", strBootStrapLocation);
		 * seleniumBO selBO = new seleniumBO("admin123", "admin123", "PMDB84", strBootStrapLocation);
		 ...
		 * selBO.BO_CreateFinancialPeriod("FP1", "07/02/2007", "07/08/2007");
		 * selBO.BO_CreateFinancialPeriod("S2", "01-Jan-10", "30-Jan-10");
		 */
		
		seleniumBO selBO = new seleniumBO("admin", "admin", "p6db", strBootStrapLocation);
		//selBO.BO_CreateResource("Srini");
		//selBO.BO_CreatePortfolio("Port4512", "Test");
		//seleniumBO selBO = new seleniumBO("user8", "Primavera1", "P6DB", strBootStrapLocation);
		//selBO.BO_ResetAdminPreferences();
		selBO.BO_CreateProject("P0Srin1i", "P0Sri1ni");		// This is a road block
		//selBO.BO_CreateFinancialPeriod("S4", "13-MAR-15 10:00 AM", "19-MAR-15 10:00 AM");
		//selBO.BO_CreateResource("Res1234");
